...
describe('Sovereign PWA shell', () => {
  ...
  it('contains public Sovereign positioning, Free plus Sovereign+, and no incident-first legacy copy', () => {
    expect(app).toContain('Sovereign.OS is a private Baseline environment');
    expect(app).toContain('One Sovereign workspace');
    ...
    expect(app).not.toContain('Live a life you’d choose to watch again');
