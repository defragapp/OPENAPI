    ...
    <div className="powder-app">
      ...
      <main className="powder-main">
        ...
        <section className="powder-hero">
          <div className="try-badge"><span className="dot"/> Personal Intelligence</div>
          <h1>Private intelligence for real life.</h1>
          <p>Understand yourself, your relationships, your decisions,<br/>and the systems around you.</p>
        ...
        <section className="powder-interface">
          <div className="interface-card">
            ...
            <div className="prompt-box">
              <input type="text" placeholder="Ask about a decision, a reaction, a relationship…" readOnly />
            ...
            <ul className="suggestion-list">
              <li><span>Why does the same conversation feel calm to them and urgent to me?</span><span className="arrow">→</span></li>
              <li><span>How do I know whether I’m refining an idea or anticipating everyone else’s reaction?</span><span className="arrow">→</span></li>
              <li><span>What role do I keep ending up in across this team?</span><span className="arrow">→</span></li>
              <li><span>Where does my Baseline support taking space here?</span><span className="arrow">→</span></li>
            </ul>
          </div>
        </section>
      </main>
