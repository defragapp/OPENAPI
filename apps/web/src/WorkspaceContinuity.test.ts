...
describe('workspace continuity', () => {
  ...
  it('uses one honest assistant processing state', () => { expect(source).toContain("const preparing = 'Exploring your question through your Baseline…'"); expect(source).not.toContain("'Connecting your Baseline'"); });
