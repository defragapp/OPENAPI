    ...
    <div className="sov-page">
      ...
      <section className="sov-section">
        ...
        <div className="sov-feature-grid">
          <div className="sov-card"><div className="sov-card-icon">🌟</div><h3>Input your natal data</h3><p>Enter your birth date, time, and location. We fetch ephemeris data from NASA JPL Horizons to build your Baseline.</p></div>
          <div className="sov-card"><div className="sov-card-icon">🤖</div><h3>AI grounded in your chart</h3><p>Every conversation is contextualized with your blueprint. The AI understands your design, not just your question.</p></div>
          <div className="sov-card"><div className="sov-card-icon">💬</div><h3>Threaded conversations</h3><p>Save and revisit readings. Each thread maintains full context of your ongoing exploration.</p></div>
          <div className="sov-card"><div className="sov-card-icon">🔒</div><h3>Private &amp; secure</h3><p>Your data stays on Cloudflare's edge. Magic-link auth, HttpOnly sessions, no third-party tracking.</p></div>
          <div className="sov-card"><div className="sov-card-icon">⚡</div><h3>Edge-native performance</h3><p>Everything runs on Cloudflare's global network — AI responses stream in real-time from the nearest data center.</p></div>
          <div className="sov-card"><div className="sov-card-icon">💳</div><h3>Simple tiered pricing</h3><p>Free tier with 10 AI turns/month. Upgrade to Sovereign+ for 300 turns and unlimited threads.</p></div>
        </div>
      </section>
      <section className="sov-section">
        <h2>Pricing</h2>
        <div className="sov-pricing-grid">
          <div className="sov-pricing-card"><h3>Free</h3><div className="sov-price">$0<span>/mo</span></div><ul><li>10 AI turns per month</li><li>3 chat threads</li><li>Natal data intake</li><li>Community support</li></ul><a href="/signup" className="sov-btn sov-btn-ghost sov-btn-block">Get started</a></div>
          <div className="sov-pricing-card sov-pricing-featured"><div className="sov-badge">Most popular</div><h3>Sovereign+</h3><div className="sov-price">$20<span>/mo</span></div><ul><li>300 AI turns per month</li><li>Unlimited chat threads</li><li>Streaming responses</li><li>Priority support</li></ul><a href="/signup" className="sov-btn sov-btn-primary sov-btn-block">Start Sovereign+</a></div>
          <div className="sov-pricing-card"><h3>Sovereign+ Annual</h3><div className="sov-price">$200<span>/yr</span></div><ul><li>Everything in Sovereign+</li><li>2 months free</li><li>3600 AI turns per year</li><li>Priority support</li></ul><a href="/signup" className="sov-btn sov-btn-ghost sov-btn-block">Save with annual</a></div>
        </div>
      </section>
      <Footer />
    </div>
...
function FAQ() {
  const faqs = [
    ...
    { q: 'How do I get support?', a: 'Email info@sovereign.os. Sovereign+ subscribers receive priority response.' },
  ];
  return (
    <div className="sov-page">
      <Nav />
  ...
  return (
    <div className="sov-page">
      ...
      <div className="sov-content">
        ...
        <h2>Contact</h2>
        <p>Questions? Email <a href="mailto:info@sovereign.os">info@sovereign.os</a></p>
      </div>
      <Footer />
    </div>
  );
