...
describe('Sovereign.OS public experience', () => {
  ...
  it('keeps support pages, consent, and fallback routes intact with current public language', () => {
    ...
    expect(pricing).toContain('/experience-static-refinement-v1.css?v=20260831-acceptance-v1');
    ...
    expect(faq).toContain('/experience-static-refinement-v1.css?v=20260831-acceptance-v1');
    ...
    expect(notFound).toContain('/experience-static-refinement-v1.css?v=20260831-acceptance-v1');
    expect(consent).toContain('You control what another person can use with you.');
    expect(consent).toContain('/experience-static-refinement-v1.css?v=20260831-acceptance-v1');
