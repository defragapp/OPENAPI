...
const LEGACY_RELEASE_COMPATIBILITY = [
...
export function installV0ReleaseFingerprint(): void {
  ...
  document.documentElement.dataset.sovereignLegacyV0Sequence = V0_LEGACY_SEQUENCE_FINGERPRINT;
  ...
  document.documentElement.dataset.sovereignLegacyReleaseCompatibility = LEGACY_RELEASE_COMPATIBILITY;
}
