...
const sansTypographyReplacement = "  assert(String(audit.typography.headingFamily).includes('Avenir Next'), `${label}: heading is not using Avenir Next (${audit.typography.headingFamily})`);";
