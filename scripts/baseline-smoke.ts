...
async function main() {
  ...
  console.log('Baseline smoke passed raw_excluded=true uncertainty_preserved=true unavailable_fails_closed=true provenance=true sovv_commit=a3db94bccc75089723bef0cf5ff36c47064bd789');
}
