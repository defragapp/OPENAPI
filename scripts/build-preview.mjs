...
for (const key of ['d1_databases', 'durable_objects', 'migrations', 'ai', 'assets', 'r2_buckets', 'services']) {
...
run(pnpm, ['--filter', '@sovereign/baseline-worker', 'exec', 'wrangler', 'types', resolve(root, '.tmp/preview-baseline-worker-configuration.d.ts'), '--env', 'preview']);
...
console.log('Preview build verified: assets, baseline Worker, Sovereign Worker, wrangler preview environment, generated binding types, and Worker dry-runs passed.');
