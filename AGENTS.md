...
- Determine safety disposition in deterministic server code before ordinary interpretation. The primary answer model may not decide whether a request is standard, grounded, urgent, emergency, or securely refused.
